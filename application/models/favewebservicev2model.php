...
class Favewebservicev2model extends CI_Model {
...
// return $this->db->affected_rows();
    ...
    public function getAllHiredUserDataBuddy2($job_id) {
        ...
        $this->db->join('tbl_jobs_status', 'tbl_jobs_status.id = tbl_applied_by.job_status_id', 'left');
        $this->db->order_by("tbl_applied_by.created", "desc");
        $where = "(job_id='$job_id' ) AND (tbl_applied_by.job_status_id='8' OR tbl_applied_by.job_status_id='2' OR tbl_applied_by.job_status_id='10' ".$appliedId.") AND tbl_applied_by.job_status_id !='1'";
        $this->db->where($where);
        $query = $this->db->get();
        if ($query->num_rows()) {
            return $query->result_array();
